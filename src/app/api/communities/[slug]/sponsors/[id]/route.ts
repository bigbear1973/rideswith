...
// GET /api/communities/[slug]/sponsors/[id] - Get a single sponsor
export async function GET(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    if (!sponsor || sponsor.brandId !== brand.id) {
      return NextResponse.json({ error: "Sponsor not found" }, { status: 404 });
    }

    return NextResponse.json(sponsor);
  } catch (error) {
    console.error("GET /api/communities/[slug]/sponsors/[id] error:", error);
...
// PUT /api/communities/[slug]/sponsors/[id] - Update a sponsor
export async function PUT(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    console.error("PUT /api/communities/[slug]/sponsors/[id] error:", error);
    return NextResponse.json(
...
// DELETE /api/communities/[slug]/sponsors/[id] - Delete a sponsor
export async function DELETE(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    console.error("DELETE /api/communities/[slug]/sponsors/[id] error:", error);
    return NextResponse.json(
